...
CREATE TABLE `command` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKcommand389838` (`user_email`),
  CONSTRAINT `FKcommand389838` FOREIGN KEY (`user_email`) REFERENCES `user` (`email`)
...
INSERT INTO `command` VALUES (1,'2022-01-07 00:00:00',_binary '\0','isaline.didier@outlook.com'),(2,'2022-01-08 00:00:00',_binary '\0','azerty@iqufnv.com'),(3,'2022-01-08 00:00:00',_binary '','azerty@iqufnv.com');
...
INSERT INTO `lineitem` VALUES (1,4,1000000,1,3),(2,1,11879.2,2,1),(3,3,4000000,2,2),(4,1,1000000,2,3),(5,1,4000000,3,2),(6,1,1000000,3,3);
...
INSERT INTO `user` VALUES ('srtgdh@outlook.com','Isaline','Didier',0,'Sensenruth','United State','$2a$10$MczIKuGUAzlXgCuX/VLEq.j2wBJvBdYkan6hDdAJIdIEwIkS7CvYK',6832,'Rue des Minières 6','','473507157','azertyuio','ROLE_USER',1,1,1,1),('isaline.didier@outlook.com','Isaline','Didier',0,'Sensenruth','United State','$2a$10$WbdLx3PJ1Kki3rhYmxtlPOh8kAbadvM5hiel/JJa/ogPS4Y9sug/i',6832,'Rue des Minières 6','','473507157','isa','ROLE_USER',1,1,1,1),('didier@outlook.com','Isaline','Didier',0,'Sensenruth','United State','$2a$10$5nB9MzUiaa2vGZPNKbchXOdi.93/Kt/PlsalDUGSQeaBs1GEsxKpG',6832,'Rue des Minières 6','','473507157','isaline','ROLE_USER',1,1,1,1),('azerty@iqufnv.com','Isaline','Didier',0,'Sensenruth','United State','$2a$10$r1erxEuZ/Bv2HDo2qovuKe8rhs6JubjD8ikcW7Zn31NqOZYoYA9DK',6832,'Rue des Minières 6','','473507157','isaline2','ROLE_USER',1,1,1,1),('isali@outlook.com','Isaline','Didier',0,'Sensenruth','United State','$2a$10$Jtt/lKa4DOboK4LFfmiqDORH1jI6nkeMrrHcTgjzeo70EAFDv8KpG',6832,'Rue des Minières 6','','473507157','isaline3','ROLE_USER',1,1,1,1),('drfghjk@outlook.com','Isaline','Didier',0,'Sensenruth','United State','$2a$10$hNXP8xQgnzv4OBVks5xUneAmKTUAWoCGr9yYkx8HcRn2JQRdJmXp.',6832,'Rue des Minières 6','','473507157','isaline4','ROLE_USER',1,1,1,1),('trfygui@outlook.com','Isaline','Didier',1,'Sensenruth','United State','$2a$10$uiiH8CCfUFxnvuZI8lSzD./w3INkB1FpMx3OdR1OREB53awfyhWtG',6832,'Rue des Minières 6','','473507157','isaline5','ROLE_USER',1,1,1,1),('fxyjr@outlook.com','Isaline','Didier',1,'Sensenruth','United State','$2a$10$Ic45fMgD1cfdmtw2/M51iuSVBsGQlQGElRLJrzN/HSo3D9okUOaPq',6832,'Rue des Minières 6','','473507157','isaline6','ROLE_USER',1,1,1,1),('swh@outlook.com','Isaline','Didier',1,'Sensenruth','United State','$2a$10$LHKHVpNSovmniQ/sxur3XuGq8fX9q7czl4uJ88sQa9xRwzzNVc1K.',6832,'Rue des Minières 6','','473507157','isaline7','ROLE_USER',1,1,1,1),('hsrjr@outlook.com','Isaline','Didier',1,'Sensenruth','United State','$2a$10$Z2NBPIKt71t2zWnNoZ0UM.Jg1zoj70wY3EEx0Yz7H83lEUBzK/b1y',6832,'Rue des Minières 6','','473507157','isaline8','ROLE_USER',1,1,1,1);
...
-- Dump completed on 2022-01-08 15:25:04
